JOURNALATOR_LOCALES.enUS = function()
  ...
  L["INVEST_O_NATOR_TITLE"] = "Journalator - Invest-o-nator"
  ...
  L["INVEST_O_NATOR"] = "Invest-o-nator"
  L["NO_PORTFOLIOS_FOUND"] = "No portfolios found"
  L["PORTFOLIOS"] = "Portfolios"
  L["CREATE_PORTFOLIO"] = "Create Portfolio"
  L["CREATE"] = "Create"
  L["CANCEL"] = "Cancel"
  L["PORTFOLIO_NAME"] = "Portfolio Name"
  L["TOTAL_INVESTMENT"] = "Total Investment"
  L["ADD_ITEM"] = "Add Item"
  L["ITEM_NAME"] = "Item Name"
  L["TARGET_AMOUNT"] = "Target Amount"
  L["ITEM_LINK_OR_ID"] = "Item (name, itemID or link)"
  L["PURCHASED_AMOUNT"] = "Purchased Amount"
  L["REMAINING_AMOUNT"] = "Remaining Amount"
  L["COMPLETION_PERCENTAGE"] = "Completion %"
  L["DELETE_PORTFOLIO"] = "Delete Portfolio"
  L["DELETE_ITEM"] = "Delete Item"
  L["PORTFOLIO_PROGRESS"] = "Portfolio Progress"
  L["TOTAL_SPENT"] = "Total Spent"
  L["REMAINING_BUDGET"] = "Remaining Budget"
  L["COMPLETED_ITEMS"] = "Completed Items"
